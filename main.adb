...
F:G$UART_TxChar$0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$UART_RxChar$0$0({2}DF,SC:U),C,0,0,0,0,0
F:G$main$0$0({2}DF,SI:S),C,0,0,0,0,0
S:Lmain.UART_Init$baudrate$1$1({2}SI:S),R,0,0,[r6,r7]
S:Lmain.UART_TxChar$ch$1$3({1}SC:U),R,0,0,[]
S:Lmain.main$i$1$6({1}SC:U),R,0,0,[r7]
S:Lmain.main$a$1$6({58}DA58d,SC:U),E,0,0
S:Lmain.main$ch$1$6({1}SC:U),R,0,0,[]
...
S:G$UART_TxChar$0$0({2}DF,SV:S),C,0,0
S:G$UART_RxChar$0$0({2}DF,SC:U),C,0,0
